...
class QuotesSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        # for urls in 
        urls = [
            'https://sinta.kemdikbud.go.id/affiliations/authors/414?page=1',
            'https://sinta.kemdikbud.go.id/affiliations/authors/414?page=2',
        ]
        for url in urls:
        ...
        for i in range (4, 14):
            for dosen in response.css('body > div > div.col-md-8 > div.content > div > div.au-list-affil.mt-3'):
                yield {
                    ...
                    'dept': dosen.css('div:nth-child(' + str(i) + ') > div > div.col-lg > div.row > div:nth-child(1) > div.profile-dept > a::text').extract(),
                    'sinta_id': dosen.css('div:nth-child(' + str(i) + ') > div > div.col-lg > div.row > div:nth-child(1) > div.profile-id::text').extract(),
                    'scopus_h_index': dosen.css('div:nth-child(' + str(i) + ') > div > div.col-lg > div.row > div:nth-child(1) > div.profile-hindex > span.profile-id.text-warning::text').extract(),
                    'gs_h_index': dosen.css('div:nth-child(' + str(i) + ') > div > div.col-lg > div.row > div:nth-child(1) > div.profile-hindex > span.profile-id.text-success.ml-3::text').extract(),
